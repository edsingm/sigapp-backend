...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'tenant_host_connection' => [
            'driver' => 'pgsql',
            'url' => env('TENANCY_DB_URL', env('CENTRAL_DB_URL', env('DB_URL'))),
            'host' => env('TENANCY_DB_HOST', env('CENTRAL_DB_HOST', env('DB_HOST', '127.0.0.1'))),
            'port' => env('TENANCY_DB_PORT', env('CENTRAL_DB_PORT', env('DB_PORT', '5432'))),
            'database' => env('TENANCY_DB_DATABASE', env('CENTRAL_DB_DATABASE', env('DB_DATABASE', 'laravel'))),
            'username' => env('TENANCY_DB_USERNAME', env('CENTRAL_DB_USERNAME', env('DB_USERNAME', 'postgres'))),
            'password' => env('TENANCY_DB_PASSWORD', env('CENTRAL_DB_PASSWORD', env('DB_PASSWORD', ''))),
