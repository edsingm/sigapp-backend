...
return [
    ...
    'identification' => [
        ...
        'middleware' => [
            ...
            // Middleware\InitializeTenancyByOriginHeader::class, // Não disponível na v3.9.1
        ],
    ...
    'database' => [
         ...
         */
        'tenant_host_connection_name' => env('TENANCY_HOST_CONNECTION', 'tenant_host_connection'),
     ...
     */
    'seeder_parameters' => [
        '--class' => 'Database\Seeders\Tenant\TenantSeeder', // root seeder class
        '--force' => true,
    ],
];
