...
class TenantExportGenerator
{
    ...
    public function generate(TenantExportGeneration $generation): array
    {
        ...
        match ($generation->type) {
            ...
            TenantExportType::TENANT_PORTABILITY => throw new RuntimeException(
                'Privacy dumps are generated by dedicated jobs.',
            ),
        };
    ...
    private function fileName(TenantExportGeneration $generation): string
    {
        ...
        return match ($generation->type) {
            ...
            TenantExportType::SUBJECT_PORTABILITY => "portabilidade-titular-{$generation->requested_by}-{$date}.json",
            TenantExportType::TENANT_PORTABILITY => "portabilidade-workspace-{$date}.json",
        };
    }
}
