...
return [
    ...
    // The immutable image revision is the default release in deployed environments.
    'release' => env('SENTRY_RELEASE', env('APP_REVISION')),
    ...
    'ignore_transactions' => [
        // Ignore health/readiness traffic.
        '/up',
        '/api/v1/health',
        '/api/v1/health/live',
        '/api/v1/health/ready',
