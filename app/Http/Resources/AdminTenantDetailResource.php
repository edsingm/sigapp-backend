...
class AdminTenantDetailResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'cancelled_at' => optional($tenant->getAttribute('cancelled_at'))->toIso8601String(),
            'wipe_scheduled_at' => optional($tenant->getAttribute('wipe_scheduled_at'))->toIso8601String(),
            'wiped_at' => optional($tenant->getAttribute('wiped_at'))->toIso8601String(),
            'ai_document_transfer_accepted_at' => optional($tenant->getAttribute('ai_document_transfer_accepted_at'))->toIso8601String(),
