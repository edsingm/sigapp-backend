...
class ViabilidadeUnificadoService
{
    ...
    private function montarParametros(?Viabilidade $v): array
    {
        ...
        return [
            ...
            'gastosMensaisStand' => (float) ($v->gastos_mensais_stand ?? $defaults['gastos_mensais_stand']),
            'comissaoHousePercentual' => ($v->comissao_house_percentual ?? $defaults['comissao_house_percentual']) / 100,
            'comissaoImobiliariasPercentual' => ($v->comissao_imobiliarias_percentual ?? $defaults['comissao_imobiliarias_percentual']) / 100,
            'percentualVendasHouse' => ($v->percentual_vendas_house ?? $defaults['percentual_vendas_house']) / 100,
            ...
            'custoContratacaoCef' => (float) ($v->custo_contratacao_cef ?? $defaults['custo_contratacao_cef']),
            ...
            'percentualOutrasDespesasFinanceiras' => ((float) ($v->outras_despesas_financeiras ?? $defaults['outras_despesas_financeiras'])) / 100,
