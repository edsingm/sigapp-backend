...
@section('title', 'Contrato assinado - SIG.APP')
...
@section('content')
    ...
    <p style="margin: 0 0 12px; font-size: 15px; color: #52525b; line-height: 1.6;">
        O contrato referente ao terreno <strong>{{ $terrenoNome }}</strong> foi assinado.
    </p>

    <p style="margin: 24px 0 0; font-size: 14px; color: #71717a; line-height: 1.5;">
        Acesse o sistema para visualizar o contrato completo.
    </p>
@endsection
