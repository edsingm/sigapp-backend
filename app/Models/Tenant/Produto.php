...
class Produto extends Model
{
    ...
    protected $casts = [
        ...
        'imposto_tributos' => 'decimal:2',
        'imposto_iss' => 'decimal:2',
        'imposto_outros' => 'decimal:2',
        'meses_inicioConstrucao' => 'int',
        'porcentagem_ConstrucaoStand' => 'decimal:2',
        'gastos_mensaisStand' => 'decimal:2',
        'porcentagem_comissaoHouse' => 'decimal:2',
        'porcentagem_comissaoImobs' => 'decimal:2',
        'marketing_antesLancamento' => 'decimal:2',
        'marketing_lancamento' => 'decimal:2',
        'custo_contratacaoCef' => 'decimal:2',
        'pj_taxaJuros' => 'decimal:4',
