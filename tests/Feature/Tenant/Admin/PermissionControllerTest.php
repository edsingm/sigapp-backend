...
class PermissionControllerTest extends TestCase
{
    ...
    {
        Permission::query()->firstOrCreate(['name' => 'test.permission', 'guard_name' => 'web']);
    ...
    {
        $permission = Permission::query()->firstOrCreate(['name' => 'show.permission', 'guard_name' => 'web']);
    ...
    {
        $permission = Permission::query()->firstOrCreate(['name' => 'old.permission', 'guard_name' => 'web']);
    ...
    {
        $permission = Permission::query()->firstOrCreate(['name' => 'dashboard.viewer', 'guard_name' => 'web']);
    ...
    {
        $permission = Permission::query()->firstOrCreate(['name' => 'used.permission', 'guard_name' => 'web']);
    ...
    {
        $permission = Permission::query()->firstOrCreate(['name' => 'unused.permission', 'guard_name' => 'web']);
