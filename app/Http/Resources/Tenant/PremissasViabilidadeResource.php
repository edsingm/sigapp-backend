...
class PremissasViabilidadeResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'gastos_mensais_stand' => $this->gastos_mensais_stand,
            'comissao_house_percentual' => $this->comissao_house_percentual,
            'comissao_imobiliarias_percentual' => $this->comissao_imobiliarias_percentual,
            'percentual_vendas_house' => $this->percentual_vendas_house,
            ...
            'pagamento_comissao_venda' => $this->pagamento_comissao_venda,
