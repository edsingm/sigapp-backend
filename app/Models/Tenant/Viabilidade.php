 ...
 * @property bool $usar_antecipacao_pj
 ...
 * @property-read Collection<int, ViabilidadeSecao> $secoes
 * @property-read Collection<int, ViabilidadeAprovacao> $aprovacoes
 */
