...
class ViabilidadeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'meses_entrega' => 'nullable|integer|min:0|max:120',
            'meses_pos_obra' => 'nullable|integer|min:0|max:240',
            ...
            'variavel_correcao' => 'nullable|numeric|min:0|max:100',
            ...
            'gastos_mensais_stand' => 'nullable|numeric|min:0',
            'comissao_house_percentual' => 'nullable|numeric|min:0|max:100',
            'comissao_imobiliarias_percentual' => 'nullable|numeric|min:0|max:100',
            'percentual_vendas_house' => 'nullable|numeric|min:0|max:100',
            ...
            'pagamento_comissao_venda' => 'nullable|numeric|min:0|max:100',
            'pagamento_comissao_desligamento' => 'nullable|numeric|min:0|max:100',
            'parcelamento_comissao_meses' => 'nullable|integer|min:1|max:120',
            'parcelamento_comissao_terreno' => 'nullable|integer|min:0|max:120',
            'marketing' => 'nullable|numeric|min:0|max:100',
            'marketing_lancamento' => 'nullable|numeric|min:0|max:100',
            'marketing_inicio_antes_lancamento' => 'nullable|integer|min:0|max:60',
            ...
            'tipo_empreendimento' => 'nullable|string|in:incorporacao,loteamento',
            'estrategia_financeira' => 'nullable|string|in:cef,carteira_propria',
            'carteira_propria' => 'required_if:estrategia_financeira,carteira_propria|array',
            'carteira_propria.quantidade_lotes' => 'required_if:estrategia_financeira,carteira_propria|integer|min:1',
            'carteira_propria.preco_lote' => 'required_if:estrategia_financeira,carteira_propria|numeric|min:0',
            'carteira_propria.mes_lancamento' => 'required_if:estrategia_financeira,carteira_propria|integer|min:0',
            'carteira_propria.mes_entrega' => 'required_if:estrategia_financeira,carteira_propria|integer|min:1',
            'carteira_propria.prazo_parcelas_meses' => 'required_if:estrategia_financeira,carteira_propria|integer|in:24,36,48,72,120',
            'carteira_propria.curva_vendas_percentual' => 'required_if:estrategia_financeira,carteira_propria|array|min:1',
            'carteira_propria.curva_vendas_percentual.*' => 'numeric|min:0|max:1',
    ...
    public function attributes(): array
    {
        return [
            ...
            'meses_entrega' => 'meses até entrega',
            'meses_pos_obra' => 'meses pós-obra',
            'pis_cofins' => 'PIS/COFINS',
            'iss' => 'ISS',
            'outros_impostos' => 'outros impostos',
            'comissao' => 'comissão',
            'incorporacao' => 'incorporação',
            'variavel_correcao' => 'variável de correção',
            'incorp_ri' => 'incorporação RI',
            'incorp_entrega' => 'incorporação entrega',
            'incorp_ate_lancamento' => 'incorporação até lançamento',
            'obra_ate_lancamento' => 'obra até lançamento',
            ...
            'construcao_stand_meses_antes_lancamento' => 'construção do stand (meses antes do lançamento)',
            ...
            'bonus_equipe_comercial' => 'bônus equipe comercial',
            ...
            'parcelamento_comissao_terreno' => 'parcelamento da comissão do terreno',
            'marketing' => 'marketing',
