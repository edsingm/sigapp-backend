    ...
    public function run(): void
    {
        $plans = [
            [
                ...
                'features' => [
                    'Até 1 usuário',
                    'Cadstro e edição de terrenos',
                    'Até 50 cadastros de terrenos',
            ...
            [
                ...
                'features' => [
                    'Até 3 usuários',
                    'Até 100 cadastros de terrenos',
                    '1 GB de armazenamento para arquivos',
                    'Suporte por email',
                    'Relatórios básicos',
                    'Dashboard simples',
                    'Módulo Viabilidade simples',
                    "DRE simplificado",
                ],
                'entitlements' => [
                    'users' => ['max' => 3],
            ...
            [
                ...
                'features' => [
                    'Até 10 usuários',
                    'Até 200 cadastros de terrenos',
                    '3 GB de armazenamento para arquivos',
                    'Suporte por email',
            ...
            [
                ...
                'features' => [
                    'Usuários ilimitados',
                    'Cadastros de terrenos ilimitados',
                    '*10 GB de armazenamento para arquivos',
                    'Suporte prioritário',
                    'Relatórios avançados',
                    'Dashboard completo',
                    'Exportação de relatórios',
                    'Módulo Viabilidade completo',
                    'DRE completo',
                    'Fluxo de caixa',
                    'Kpis e Indicadores',
                    'Integração via API própria',
                ],
                'entitlements' => [
                    'users' => ['max' => -1],
                    'terrenos' => ['max' => -1],
