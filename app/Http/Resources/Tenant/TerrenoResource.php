...
class TerrenoResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'municipio_ibge_codigo' => $this->municipio_ibge_codigo,
            'municipio_nome' => $this->municipio_nome,
            'estado_sigla' => $this->estado_sigla,
            'estado_nome' => $this->estado_nome,
            'regiao_nome' => $this->regiao_nome,
            'mesorregiao_nome' => $this->mesorregiao_nome,
            'microrregiao_nome' => $this->microrregiao_nome,
