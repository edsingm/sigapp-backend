...
class ServicesArchitectureTest extends TestCase
{
    ...
    private array $migratedServices = [
        ...
        'app/Services/Tenant/Area/HydrographyService.php',
        'app/Services/Tenant/AiMonitorService.php',
        'app/Services/Tenant/CommitteeAiDossierService.php',
        'app/Services/Tenant/KmzParserService.php',
        'app/Services/Tenant/ProjetoService.php',
        'app/Services/Tenant/TenantCacheService.php',
        'app/Services/Tenant/TenantExportGenerationService.php',
        'app/Services/Tenant/TenantExportGenerator.php',
        'app/Services/Tenant/TerrenoExportService.php',
        ...
        'app/Services/Tenant/TerrenoAiReportService.php',
        ...
        'app/Services/Tenant/SubdomainPolicyService.php',
        'app/Services/Privacy/LegalDocumentService.php',
        'app/Services/Privacy/PrivacySubjectService.php',
        'app/Services/Privacy/PrivacyRequestService.php',
    ];
