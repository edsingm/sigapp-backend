...
class ViabilidadeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'incorporacao_ri' => 'nullable|numeric|min:0|max:100',
            'incorporacao_entrega' => 'nullable|numeric|min:0|max:100',
            'incorporacao_ate_lancamento' => 'nullable|numeric|min:0|max:100',
            ...
            'assistencia_tecnica_curva' => 'nullable|array|size:5',
            'assistencia_tecnica_curva.*' => 'numeric|min:0|max:100',
            ...
            'gastos_mensais_stand' => 'nullable|numeric|min:0|max:100',
            ...
            'marketing_inicio_antes_lancamento' => 'nullable|integer|min:0|max:24',
            ...
            'amortizacao_pj_parcelas' => 'nullable|integer|min:1|max:240',
